...
_start:
   ...
   push  0x656e776f	;pushing enwo pushed owned!!! to stack in little endian format
...
; char shellcode = "\x31\xc0\x31\xdb\x31\xc9\x31\xd2\xb0\x04\xb3\x01\x68\x64\x21\x21\x21\x68\x6f\x77\x6e\x65\x89\xe1\xb2\x08\xcd\x80\xb0\x01\x31\xdb\xcd\x80"
; length of shellcode = 34
